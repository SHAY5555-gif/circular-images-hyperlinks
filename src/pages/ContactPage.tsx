          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-2">
                ...
                <a href="mailto:info@circular.com" className="text-primary font-medium hover:underline">
                  info@circular.com
                </a>
              </div>
            ...
            <form className="space-y-6 glass-morphism p-8 rounded-lg animate-fade-in">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="smooth-transition border-border/50 focus:border-primary"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="min-h-32 smooth-transition border-border/50 focus:border-primary"
                />
              </div>
